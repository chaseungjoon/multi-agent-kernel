...
# ruff: noqa: E501
"""Independent multi-feature acceptance scenarios for Template 4."""

from harness.template4_spec import Case

WORKFLOWS = (
    Case(
        "submit_deliver_observe",
        """
...
""",
    ...
    Case(
        "failure_retry_dead_letter_replay",
        """
...
""",
    ...
    Case(
        "expired_worker_cannot_complete",
        """
...
""",
    ...
    Case(
        "cancel_prevents_late_completion",
        """
...
""",
    ...
    Case(
        "idempotency_conflict_and_canonicalization",
        """
...
""",
    ...
    Case(
        "cursor_pages_do_not_leak_or_repeat",
        """
...
""",
    ...
    Case(
        "backlog_and_quota_after_transition",
        """
a = Job("a", due=5)
b = Job("b", due=10)
...
""",
    ...
    Case(
        "http_backpressure_schedules_retry",
        """
...
""",
    ...
    Case(
        "retention_preserves_recoverable_work",
        """
