...
contended** function: every one of the 90 operations must add one ``register(...)``
...
from toolkit import codekit, datekit, dictkit, mathkit, numkit, parsekit, seqkit, setkit, strkit
